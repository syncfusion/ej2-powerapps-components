...
3. Click the `Browse` button and locate the solution package you generated at [`SyncfusionPowerAppsComponents/bin/Debug/SyncfusionPowerAppsComponents.zip`](../../SyncfusionPowerAppsComponents/bin/Debug/SyncfusionPowerAppsComponents.zip). Proceed to the next step by clicking `Next`.

![Solution Import 1](../images/common/PB-SolutionImport1.png)

5. Click `Import` to initiate the import process. Once completed, a success message will be displayed.

![Solution Import 2](../images/common/PB-SolutionImport2.png)

![Solution Import Success](../images/common/PB-SolutionImportSuccess.png)

6. After successfull import, click on the `Publish All Customizations` option in command bar to publish the solution package. Upon completion, a success message will confirm the publish.
